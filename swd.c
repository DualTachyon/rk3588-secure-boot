...
void dtSwdInit(void)
{
	...
	if (*(volatile uint32_t *)0xFF000010 != 5) {
		IOC_BUS_GPIO4D_IOMUX_SEL_L = 0
			| REG_ENUM_BITS_WM(IOC_BUS, GPIO4D_IOMUX_SEL_L, GPIO4D2_SEL, JTAG_TCK_M0)
			| REG_ENUM_BITS_WM(IOC_BUS, GPIO4D_IOMUX_SEL_L, GPIO4D3_SEL, JTAG_TMS_M0);
	}
}
